...
/home/engine/project/
├── src/
│   ├── BaseUtils/              # 🆕 Базовые классы и утилиты (v2.0)
│   │   ├── Cache/              # Файловое кеширование
│   │   ├── Config/             # ConfigLoader для JSON конфигов
│   │   ├── Exception/          # Иерархия исключений
│   │   ├── Netmap/             # Утилиты для сетевых топологий
│   │   ├── docs/               # Документация базовых классов
│   │   ├── examples/           # Примеры использования
│   │   ├── tests/              # Тесты базовых классов
│   │   ├── *.class.php         # Все базовые классы (16 файлов)
│   │   ├── README.md           # Обзор BaseUtils
│   │   ├── INDEX.md            # Полный индекс классов
│   │   └── MIGRATION_GUIDE.md  # Руководство по миграции
│   ├── TelegramBot/            # Модуль Telegram бота
│   ├── Rss2Tlg/                # RSS to Telegram с AI
│   └── UTM/                    # API для UTM5 биллинга
├── Config/                     # Конфигурации проектов
├── autoload.php                # Автозагрузчик классов
└── composer.json               # Зависимости
```

**Важное изменение v2.0:** Все базовые классы перенесены в `src/BaseUtils/`  
📖 См. [src/BaseUtils/MIGRATION_GUIDE.md](src/BaseUtils/MIGRATION_GUIDE.md)
