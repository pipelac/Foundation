...
class MySQL
{
     ...
     * 
     * Использует PDO::quote() для экранирования спецсимволов.
     * Возвращает строку с кавычками.
     * 
     * Примечание: Рекомендуется использовать подготовленные запросы (prepared statements)
     * вместо ручного экранирования. Этот метод предназначен для специфичных случаев,
     * когда prepared statements не применимы (например, динамические имена таблиц).
     * 
     * @param string $value Строка для экранирования
     * @return string Экранированная строка с кавычками
     */
