...
| `ItemRepository.php` | Репозиторий для работы с новостями | ~514 |
| `PublicationRepository.php` | Репозиторий публикаций в Telegram | ~240 |
| `ContentExtractorService.php` | Сервис извлечения контента | ~280 |
| `AIAnalysisService.php` | Сервис AI-анализа через OpenRouter | ~400 |
| `AIAnalysisRepository.php` | Репозиторий результатов AI-анализа | ~340 |
| `PromptManager.php` | Менеджер промптов для AI | ~150 |

**Итого основные классы:** ~2814 строк

## Документация (src/Rss2Tlg/)

| Файл | Описание | Размер |
|------|----------|--------|
| `README.md` | Полная документация модуля Fetch | ~427 строк |
| `AI_ANALYSIS_README.md` | Документация модуля AI-анализа | ~650 строк |
| `schema_ai_analysis.sql` | SQL схема таблицы AI-анализа | ~60 строк |
| `INSTALL.md` | Инструкция по установке | ~240 строк |
| `QUICKSTART.md` | Быстрый старт | ~190 строк |
| `FILELIST.md` | Список файлов модуля | ~220 строк |

**Итого документация:** ~1787 строк

## Промпты (prompts/)

| Файл | Описание | Размер |
|------|----------|--------|
| `INoT_v1.xml` | Базовый промпт для AI-анализа новостей | ~280 строк |

**Итого промпты:** ~280 строк
...
| `ai_analysis_demo.php` | Демонстрация AI-анализа новостей | ~220 |

**Итого примеры:** ~900 строк
