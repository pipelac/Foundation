...
CREATE TABLE `rss2tlg_deduplication` (
  ...
  `similarity_method` enum('ai','hash','hybrid','preliminary') DEFAULT NULL COMMENT 'Метод определения схожести',
...
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Результаты проверки новостей на дубликаты';
...
(48,469,3,'checked',0,NULL,42.50,'ai',1,'[]',NULL,'[]','google/gemma-3-27b-it',3979,0,3,0,NULL,NULL,'2025-11-11 19:26:46','2025-11-11 19:26:37','2025-11-11 19:26:46'),
(50,470,3,'checked',0,NULL,65.00,'ai',1,'[]',NULL,'[]','google/gemma-3-27b-it',4010,0,3,0,NULL,NULL,'2025-11-11 19:26:56','2025-11-11 19:26:47','2025-11-11 19:26:56'),
(52,471,3,'checked',0,NULL,35.00,'ai',1,'[]',NULL,'[]','google/gemma-3-27b-it',3424,0,1,0,NULL,NULL,'2025-11-11 19:27:07','2025-11-11 19:26:57','2025-11-11 19:27:07'),
(54,472,3,'checked',0,NULL,35.00,'ai',1,'[]',NULL,'[]','google/gemma-3-27b-it',3929,0,3,0,NULL,NULL,'2025-11-11 19:27:16','2025-11-11 19:27:07','2025-11-11 19:27:16'),
(56,473,3,'checked',0,NULL,35.20,'ai',1,'[]',NULL,'[]','google/gemma-3-27b-it',3978,0,3,0,NULL,NULL,'2025-11-11 19:27:24','2025-11-11 19:27:16','2025-11-11 19:27:24');
...
-- Dump completed on 2025-11-11 19:28:15
