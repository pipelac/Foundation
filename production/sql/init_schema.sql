-- ============================================================================
-- НАСТРОЙКА КОДИРОВКИ ДЛЯ WINDOWS MYSQL-КЛИЕНТА
-- ============================================================================
-- Эти команды гарантируют, что файл будет корректно импортирован на Windows
-- где клиент mysql по умолчанию использует cp1251/latin1
-- ============================================================================
...
-- Обновления:
--   v2.1 (2025-01-13):
--   - Добавлены команды SET NAMES для корректной работы на Windows
--   - Исправлена проблема с cp1251/latin1 на Windows MySQL-клиенте
--   
--   v2.0 (2025-11-13):
...
-- ============================================================================
-- ВОССТАНОВЛЕНИЕ НАСТРОЕК MYSQL-КЛИЕНТА
-- ============================================================================
